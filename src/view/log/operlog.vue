        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-select v-model="query.state" @change="loginStatus" placeholder="全部日志" label="状态"
                        ...
                        <el-option key="1" label="异常" value="0" ></el-option>
                    </el-select>              
            ...
            <el-table-column type="expand">
                ...
                <el-table-column prop="title" label="操作名称"  align="center"></el-table-column>
                <el-table-column prop="operIp" label="IP地址" align="center"></el-table-column>
                <el-table-column prop="operType" label="操作类型"  align="center"></el-table-column>
                <el-table-column prop="operUrl" label="请求路径" width="160px"></el-table-column>
                <!-- <el-table-column v-if="query.state ==='1'" prop="result" label="操作结果"></el-table-column> -->
                <el-table-column v-if="query.state ==='0'"  prop="errorMsg" label="异常信息"></el-table-column>
                <el-table-column  label="操作时间" prop="createTime" width="155px"></el-table-column>
...
export default {
    ...
    methods: {
        // 获取日志列表
        getData() {
            api.getOperLog(this.query).then((result) => {
        ...
        handleDelete(val) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                api.delOperlog(ids).then((result)=>{
                    if(result.success){
